...
export default class Dicot extends Sprite {
  constructor(...args) {
    super(...args);
    ...
    this.costumes = [
      new Costume(
        ...
        "./Dicot/costumes/blue_bubble-removebg-preview.png",
        { x: 360, y: 353 }
      )
    ];
    ...
    this.sounds = [
      new Sound(
        ...
        "./Dicot/sounds/Bubble, pop sound effect.mp3"
      )
    ];
