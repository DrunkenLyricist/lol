...
export default class NoVasTissue extends Sprite {
  constructor(...args) {
    super(...args);
    ...
    this.costumes = [
      new Costume(
        ...
        "./NoVasTissue/costumes/blue_bubble-removebg-preview.png",
        { x: 360, y: 353 }
      )
    ];
    ...
    this.sounds = [
      new Sound(
        ...
        "./NoVasTissue/sounds/Bubble, pop sound effect.mp3"
      )
    ];
